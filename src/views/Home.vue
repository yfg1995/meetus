<template lang="">
      ...
      <div class="member__card d-flex">
        ...
        <div class="member__content">
          ...
          <ul class="member__contact">
            ...
            <li>
              <a href="#" target="_blank" class="member-mail cp">
                <svg viewBox="0 0 512 512">
                  <path
  ...
  <section class="home-about__info">
    <div class="container">
      <div class="member__info d-flex justify-between align-center">
        ...
        <!-- member about -->
        <div class="member__skill_main">
          <ProgressBar
            v-if="members[0].skills"
            :skills="Object.entries(members[0].skills)"
          />
        </div>
        <!-- member skill main -->
      </div>
...
.home-about__banner .member__card {
  ...
  padding: 40px;
  width: 100%;
  box-shadow: 0px 20px 80px 0px rgb(153 153 153 / 40%);
}
.home-about__banner .member__card h3 {
  line-height: 1.25em;
  margin-top: 10px;
}
.home-about__banner .member__bg {
  max-width: 53%;
  padding-bottom: 60%;
}
.home-about__banner .member__content {
  max-width: 43%;
  margin-top: 0;
  padding: 0 30px;
}

    ...
    <div class="container">
      <div class="section text-sample">
        ...
        <p>
          ...
          making that <i>Italic</i> interest documentary, or short film to show
          off their creative prowess. Many have great ideas and want to “wow”
          ...
          easy feat), how do you move from a <del>Strike</del> through of master
        ...
        <div class="definiton-row d-flex justify-between align-center">
          <div class="definition-row__col">
            ...
            <p>
              ...
              them through any US bank or payment system. As a result of this
              law, most of the popular online casino networks such as Party
              Gaming and PlayTech left the United States.
            </p>
          </div>
      ...
      <div class="section block-quotes">
        <h3>block quotes</h3>
        <div class="block-quotes__content">
          <p>
            Recently, the US Federal government banned online casinos from
            ...
            clarification and start doing business with me.
          </p>
        </div>
      </div>
      <!-- =======block-quotes======= -->
          ...
          <div class="checkboxes-col">
            ...
            <div class="single-element-widget">
              ...
              <div class="switch-wrap d-flex">
                ...
                <div class="switch confirm-switch">
            ...
            <div class="single-element-widget">
              ...
              <div class="switch-wrap d-flex justify-between">
                ...
                <div class="checkbox confirm-checkbox">
...
/* BLOCK QUOTES */
.block-quotes__content {
  border-left: 2px solid var(--elements-c-primary);
  padding: 30px 50px;
}
...
.image-gallery__container--item img {
  width: 100%;
  height: 100%;
  object-fit: cover;
}
...
.single-element-widget h3 {
  margin-bottom: 20px;
}
.switch-wrap:not(:last-of-type) {
  margin-bottom: 8px;
}
.switch {
  width: 35px;
